...
public class QuestionLibrary2016_2 {
    ...
    public   static  String mQuestions [] = {
            ...
            "12." +
                    "지문의 흐름을 고려했을 때 빈칸에 들어갈 말로 가장 적절한 것은?" +
            ...
            "13. " +
                    "다음 글에 드러난 Liz의 심경 변화로 가장 적절한 것은?" +
